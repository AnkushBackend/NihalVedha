...
const BulkEnquiry = lazy(() => import("./pages/BulkEnquiry")); // NEW

/* Home page sections as a component */
function Home() {
  const slides = [
  ...
  return (
    <>
      ...
      <ScrollSwapRow heading="POCKET SNACKS" />
      ...
      <div style={{ height: "clamp(10px, 2vw, 24px)" }} />
      <VideoBanner
        src="/video/pumpkin-hero.mp4"
        poster="/video/pumpkin-hero.jpg"
        heightClamp="clamp(220px, 32vw, 520px)"
      />
    </>
  );
}
    ...
    <>
      ...
      <Suspense fallback={<div style={{ padding: 24 }}>Loading…</div>}>
        <Routes>
          ...
          <Route path="/bulk" element={<BulkEnquiry />} /> {/* NEW */}
